...
def create_decoder(x, level_1, level_2, level_3, level_4):
...
def unet_tgce(
    ...
    level_1, level_2, level_3, level_4 = create_encoder(input_layer)
    x = create_decoder(input_layer, level_1, level_2, level_3, level_4)
    xy = DefaultConv2D(
        out_channels,
        kernel_size=(1, 1),
